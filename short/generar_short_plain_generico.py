...
from adapter.tts_adapter import crear_tts_v3
from generator.cleanup import limpiar_temporales #Listo en V3
from generator.utils.calculo_bloques import dividir_en_bloques, calcular_duracion_bloque #Listo en V3
from generator.decision import decidir_imagen_video #Listo en V3
from generator.utils.voice_ab import decidir_tts_para_video #Listo en V3
...
def generar_short_plain(
    *,
    ...
    print("[V3] Creando imagen de título...")
    print("[V3] Título:", titulo)
    ...
    print("[V3] Título creado en:", base_path_assest + "/tmp/titulo.png")
